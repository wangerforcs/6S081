...
int main(int argc, char *argv[]){
   ...
   6:	0800                	addi	s0,sp,16
    if(argc < 2){
   8:	4785                	li	a5,1
   a:	02a7d263          	bge	a5,a0,2e <main+0x2e>
  ...
  14:	1e2080e7          	jalr	482(ra) # 1f2 <atoi>
    if(sleep(n) < 0){
  18:	00000097          	auipc	ra,0x0
  1c:	364080e7          	jalr	868(ra) # 37c <sleep>
  ...
  32:	7e258593          	addi	a1,a1,2018 # 810 <malloc+0xf2>
  36:	4509                	li	a0,2
  38:	00000097          	auipc	ra,0x0
  3c:	600080e7          	jalr	1536(ra) # 638 <fprintf>
        exit(1);
  40:	4505                	li	a0,1
  ...
  4e:	7e658593          	addi	a1,a1,2022 # 830 <malloc+0x112>
  52:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	4d850513          	addi	a0,a0,1240 # 8a8 <digits>
 3d8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 494:	3c0c8c93          	addi	s9,s9,960 # 850 <malloc+0x132>
 ...
 4a2:	40ab8b93          	addi	s7,s7,1034 # 8a8 <digits>
 ...
 5c8:	28498993          	addi	s3,s3,644 # 848 <malloc+0x12a>
        while(*s != 0){
 5cc:	85ee                	mv	a1,s11
